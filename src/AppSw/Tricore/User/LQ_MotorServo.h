...
#define Servo_Right_Max   (Servo_Center_Mid-240)      //舵机左转极限值
#define Servo_Left_Min  (Servo_Center_Mid+230)      //舵机右转极限值，此值跟舵机放置方式有关，立式

#define MtTargetDuty  3000  //电机占空比值得最大值，实际需要减去电池电压，编码器，赛道曲率，达不到该值
extern int Servo_duty,servoTurnDuty;
